# Linear_Regression Model Implementation

This repository contains the implementation of a linear regression model used to answer the following problem statement - 
